...
| [`standalone-docs`](standalone-docs/SKILL.md) | Before creating any markdown file that is not a README, CHANGELOG, or CLAUDE.md -- the default is no; route the content instead, and any doc that survives carries a pre-release accuracy check |
